    ...
    const columns = [
        ...
        ...(props.canApproveReject ? [{
                ...
                onRender: (item) => {
                    ...
                    const isBusy = props.actionInProgressId === item.id;
                    const availableStock = getAvailableStock(props.inventoryItems, item);
                    ...
                    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: '8px' } },
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { style: { display: 'flex', gap: '8px' } }),
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_2__.PrimaryButton, { text: "Approve", onClick: () => props.onApproveRequest && props.onApproveRequest(item), disabled: isBusy || !hasEnoughStock }),
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("df2e5364e1dc6f8a3a56")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=inventory-management-web-part.ddb0073d7de7a9708ece.hot-update.js.map