...
const WorkflowPopup = (props) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react_lib_Dialog__WEBPACK_IMPORTED_MODULE_1__.Dialog, { hidden: !isOpen, onDismiss: onDismiss, dialogContentProps: {
        ...
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: '16px', fontFamily: 'inherit' } },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '12px' } },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { style: {
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react_lib_Icon__WEBPACK_IMPORTED_MODULE_3__.Icon, { iconName: iconName, style: { fontSize: '20px', color: iconColor } })),
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null,
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { style: {
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("h3", { style: { margin: 0, fontSize: '1.1rem', fontWeight: 600, color: 'var(--text-main, #1f2937)' } }, title))),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", { style: { margin: 0, fontSize: '0.88rem', color: 'var(--text-main, #4b5563)', lineHeight: 1.5 } }, message),
            details && (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { style: {
                ...
                details.requestId && (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null,
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { style: { color: 'var(--text-muted, #6b7280)', display: 'block', marginBottom: '2px' } }, "Request ID"),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("strong", { style: { color: 'var(--text-main, #111827)' } }, details.requestId))),
                details.assetTitle && (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null,
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { style: { color: 'var(--text-muted, #6b7280)', display: 'block', marginBottom: '2px' } }, "Asset"),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("strong", { style: { color: 'var(--text-main, #111827)' } },
                        details.assetTitle,
                        " ",
                        details.quantity ? `(Qty: ${details.quantity})` : ''))),
                details.requesterName && (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null,
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { style: { color: 'var(--text-muted, #6b7280)', display: 'block', marginBottom: '2px' } }, "Requester"),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("strong", { style: { color: 'var(--text-main, #111827)' } }, details.requesterName))),
                details.managerName && (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null,
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { style: { color: 'var(--text-muted, #6b7280)', display: 'block', marginBottom: '2px' } }, "Manager's Name"),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("strong", { style: { color: 'var(--text-main, #111827)' } }, details.managerName))),
                details.status && (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null,
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { style: { color: 'var(--text-muted, #6b7280)', display: 'block', marginBottom: '2px' } }, "Workflow Status"),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { style: {
                            backgroundColor: badgeBg,
                            color: badgeTextColor,
                            padding: '2px 8px',
                ...
                details.date && (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null,
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { style: { color: 'var(--text-muted, #6b7280)', display: 'block', marginBottom: '2px' } }, "Date"),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("strong", { style: { color: 'var(--text-main, #111827)' } }, details.date))),
                details.condition && (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null,
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { style: { color: 'var(--text-muted, #6b7280)', display: 'block', marginBottom: '2px' } }, "Condition"),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("strong", { style: { color: 'var(--text-main, #111827)' } }, details.condition))),
                details.comment && (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { style: { gridColumn: '1 / -1' } },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { style: { color: 'var(--text-muted, #6b7280)', display: 'block', marginBottom: '2px' } }, "Manager / Admin Notes"),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { style: {
                        ...
                        details.comment,
                        "\u201D")))))),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react_lib_Dialog__WEBPACK_IMPORTED_MODULE_4__.DialogFooter, { styles: { actionsRight: { marginTop: '16px' } } },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react_lib_Button__WEBPACK_IMPORTED_MODULE_5__.PrimaryButton, { text: "Got it", onClick: onDismiss, iconProps: { iconName: 'Accept' } }))));
};
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("3c8886664e99a139f259")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=inventory-management-web-part.d6a22e0638d2b6166a03.hot-update.js.map