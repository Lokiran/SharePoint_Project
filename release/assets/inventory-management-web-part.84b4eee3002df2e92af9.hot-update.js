...
/* harmony import */ var _utils_WarrantyUtils__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ../utils/WarrantyUtils */ 98126);
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module './IncidentRequest/IncidentRequestModule'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
class InventoryManagement extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor(props) {
        ...
        this._renderAssetAnalysis = (asset) => {
            const lifecycleInfo = (0,_utils_WarrantyUtils__WEBPACK_IMPORTED_MODULE_32__.getAssetLifecycleInfo)(asset.purchaseDate);
            const warrantyInfo = (0,_utils_WarrantyUtils__WEBPACK_IMPORTED_MODULE_32__.getWarrantyColorInfo)(asset.warrantyExpiry);
                ...
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { style: { backgroundColor: '#f8fafc', padding: '16px', borderRadius: '8px', border: '1px solid #e2e8f0' } },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_28__.Stack, { tokens: { childrenGap: 12 } },
                        ...
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null,
                            ...
                            asset.warrantyExpiry ? (warrantyInfo.isExpired ? (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_30__.MessageBar, { messageBarType: _fluentui_react__WEBPACK_IMPORTED_MODULE_27__.MessageBarType.error, styles: { root: { borderRadius: '6px' } } },
                                ...
                                "). Any future repair operations will incur full direct business costs.")) : warrantyInfo.isLessThan6Months ? (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_30__.MessageBar, { messageBarType: _fluentui_react__WEBPACK_IMPORTED_MODULE_27__.MessageBarType.error, styles: { root: { borderRadius: '6px' } } },
                                react__WEBPACK_IMPORTED_MODULE_0__.createElement("strong", null, "Warranty Expiring Soon (< 6 months):"),
                                " Expiration date is ",
                                react__WEBPACK_IMPORTED_MODULE_0__.createElement("strong", null, warrantyInfo.formattedDate),
                                " (",
                                warrantyInfo.remainingText,
                                "). High priority for hardware refresh/warranty renewal.")) : warrantyInfo.isLessThan1Year ? (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_30__.MessageBar, { messageBarType: _fluentui_react__WEBPACK_IMPORTED_MODULE_27__.MessageBarType.warning, styles: { root: { borderRadius: '6px' } } },
                                react__WEBPACK_IMPORTED_MODULE_0__.createElement("strong", null, "Warranty Expiring (< 1 year):"),
                                " Expiration date is ",
                                react__WEBPACK_IMPORTED_MODULE_0__.createElement("strong", null, warrantyInfo.formattedDate),
                                " (",
                                warrantyInfo.remainingText,
                                "). Plan for upcoming hardware lifecycle management.")) : (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_30__.MessageBar, { messageBarType: _fluentui_react__WEBPACK_IMPORTED_MODULE_27__.MessageBarType.success, styles: { root: { borderRadius: '6px' } } },
    ...
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("section", { className: `${_InventoryManagement_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].inventoryManagement} ${hasTeamsContext ? _InventoryManagement_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].teams : ''} ${isDarkTheme ? _InventoryManagement_module_scss__WEBPACK_IMPORTED_MODULE_1__["default"].dark : ''}` },
            ...
            (isAdmin || isManager || isEmployee) && (react__WEBPACK_IMPORTED_MODULE_0__.createElement(Object(function webpackMissingModule() { var e = new Error("Cannot find module './IncidentRequest/IncidentRequestModule'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), { ...this.props, isOpen: this.state.isIncidentFormOpen, onClose: () => this.setState({ isIncidentFormOpen: false, selectedAssetForIncident: undefined, preselectedIncidentType: undefined }), userDisplayName: activeUserDisplayName, userEmail: activeUserEmail, setIsLoading: (loading) => this.setState({ loading }), preselectedAsset: this.state.selectedAssetForIncident, preselectedIncidentType: this.state.preselectedIncidentType, onSuccessPopup: (details) => {
                    this.setState({
                        workflowPopup: {
                            isOpen: true,
            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_33__.Panel, { isOpen: this.state.lastMockEmail !== undefined, onDismiss: () => this.setState({ lastMockEmail: undefined }), type: _fluentui_react__WEBPACK_IMPORTED_MODULE_34__.PanelType.medium, headerText: "\uD83D\uDCEC Outgoing Email Notification (Developer Preview)", closeButtonAriaLabel: "Close", onRenderFooterContent: () => (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fluentui_react__WEBPACK_IMPORTED_MODULE_28__.Stack, { horizontal: true, tokens: { childrenGap: 10 }, style: { padding: '10px 0' } },
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("65036bc10ca1ff46b182")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=inventory-management-web-part.84b4eee3002df2e92af9.hot-update.js.map