...
describe("Asset Return Single-Stage Approval Regression Verification", () => {
    ...
    it("should successfully execute multi-stage return approval and physical handover verification", async () => {
        ...
        await ReturnRequestService.updateReturnRequestStatus("RR-101", "Approved", "Return approved by Manager during test.", "Loka Kiran Reddy");
        ...
        await ReturnRequestService.updateReturnRequestStatus("RR-101", "Completed", "Checked in & Verified during test.", "Loka Kiran Reddy", "Good");
