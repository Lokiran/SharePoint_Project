...
import { Pivot, PivotItem, PrimaryButton, DetailsList, DetailsListLayoutMode, SelectionMode, Stack, Dropdown } from '@fluentui/react';
...
export const ReportsPage = (props) => {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(Pivot, { selectedKey: state.reportsSelectedTab, onLinkClick: (item) => actions.onTabChange(item ? item.props.itemKey || 'insights' : 'insights'), styles: { root: { marginBottom: '20px', borderBottom: '1px solid rgba(128,128,128,0.1)' } } },
            React.createElement(PivotItem, { headerText: strings.ReportsPage.TabVisualInsights, itemKey: "insights" }),
            React.createElement(PivotItem, { headerText: strings.ReportsPage.TabDetailedReports, itemKey: "detailed" }),
            React.createElement(PivotItem, { headerText: strings.ReportsPage.TabWarrantyExpiry, itemKey: "expiry" })),
        state.reportsSelectedTab === 'insights' && (React.createElement(Stack, { tokens: { childrenGap: 24 } },
            ...
            React.createElement("div", { className: styles.responsiveGridGap20 },
        ...
        state.reportsSelectedTab === 'detailed' && (React.createElement("div", { style: { backgroundColor: 'var(--surface-color, #ffffff)', padding: '20px', borderRadius: '8px', border: '1px solid rgba(128, 128, 128, 0.12)', boxShadow: '0 2px 8px rgba(0,0,0,0.04)' } },
            React.createElement("div", { style: { display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '15px', alignItems: 'center', marginBottom: '20px' } },
                ...
                React.createElement(Stack, { horizontal: true, tokens: { childrenGap: 8 } },
                    React.createElement(PrimaryButton, { text: strings.ReportsPage.ExportExcel, iconProps: { iconName: 'ExcelDocument' }, onClick: () => {
                    ...
                    React.createElement(PrimaryButton, { text: strings.ReportsPage.ExportPDF, iconProps: { iconName: 'PDF' }, onClick: () => {
                            const filtered = items.filter(i => {
                                const typeMatch = state.reportsAssetTypeFilter === 'All' || i.assetType === state.reportsAssetTypeFilter;
                                const statusMatch = state.reportsStatusFilter === 'All' || i.status === state.reportsStatusFilter;
                                return typeMatch && statusMatch;
            ...
            React.createElement("div", { style: { display: 'flex', gap: '16px', flexWrap: 'wrap', marginBottom: '20px', padding: '12px', backgroundColor: '#f9fafb', borderRadius: '6px' } },
                React.createElement("div", { style: { minWidth: '150px' } },
                    React.createElement(Dropdown, { label: strings.ReportsPage.LabelAssetType, selectedKey: state.reportsAssetTypeFilter, options: [
                ...
                React.createElement("div", { style: { minWidth: '150px' } },
                    React.createElement(Dropdown, { label: strings.ReportsPage.LabelAssetStatus, selectedKey: state.reportsStatusFilter, options: [
        ...
        state.reportsSelectedTab === 'expiry' && (React.createElement("div", { style: { backgroundColor: 'var(--surface-color, #ffffff)', padding: '20px', borderRadius: '8px', border: '1px solid rgba(128, 128, 128, 0.12)', boxShadow: '0 2px 8px rgba(0,0,0,0.04)' } },
            React.createElement("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px' } },
                ...
                React.createElement(Stack, { horizontal: true, tokens: { childrenGap: 8 } },
                    React.createElement(PrimaryButton, { text: strings.ReportsPage.ExportExcel, iconProps: { iconName: 'ExcelDocument' }, onClick: actions.onExportWarrantyReportToExcel, styles: { root: { backgroundColor: '#107c41', borderColor: '#107c41', color: '#ffffff' } } }),
                    React.createElement(PrimaryButton, { text: strings.ReportsPage.ExportPDF, iconProps: { iconName: 'PDF' }, onClick: actions.onExportWarrantyReportToPDF, styles: { root: { backgroundColor: '#d13438', borderColor: '#d13438', color: '#ffffff' } } }))),
