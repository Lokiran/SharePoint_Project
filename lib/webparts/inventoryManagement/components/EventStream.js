    ...
    return (React.createElement("div", { style: { marginTop: '20px' } },
        React.createElement("div", { style: { marginBottom: '20px' } },
            props.errorMessage && (React.createElement("div", { style: { color: '#991b1b', backgroundColor: '#fee2e2', padding: '15px', borderRadius: '8px', marginBottom: '15px' } },
                ...
                " ",
                props.errorMessage)),
            React.createElement(SearchBox, { placeholder: "Search by asset name, title, details, user, or action...", value: searchQuery, onChange: (_, newValue) => setSearchQuery(newValue || ''), onClear: () => setSearchQuery(''), styles: { root: { maxWidth: 400 } } })),
