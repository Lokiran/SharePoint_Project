    ...
    return (React.createElement("div", { className: styles.dashboard },
        ...
        onNavigate && (React.createElement("div", { className: styles.quickActions },
            isAdmin && (React.createElement(React.Fragment, null,
                React.createElement("button", { className: styles.quickActionBtn, onClick: () => navigateTo('Inventory'), "aria-label": "View Inventory" },
                    React.createElement(Icon, { iconName: "List" }),
                    React.createElement("span", null, "View Inventory")),
                React.createElement("button", { className: styles.quickActionBtn, onClick: () => navigateTo('AssetAssignmentQueue'), "aria-label": "Assignment Queue" },
                    React.createElement(Icon, { iconName: "Send" }),
                    React.createElement("span", null, "Assignment Queue")),
                React.createElement("button", { className: styles.quickActionBtn, onClick: () => navigateTo('Reports'), "aria-label": "View Reports" },
                    React.createElement(Icon, { iconName: "ReportDocument" }),
                    React.createElement("span", null, "Reports")),
                React.createElement("button", { className: styles.quickActionBtn, onClick: () => navigateTo('EventStream'), "aria-label": "Event Stream" },
            ...
            isManagerView && (React.createElement(React.Fragment, null,
                React.createElement("button", { className: styles.quickActionBtn, onClick: () => navigateTo('Approvals'), "aria-label": "Review Approvals" },
                    React.createElement(Icon, { iconName: "DoubleChevronRight12" }),
                    React.createElement("span", null, "Review Approvals")),
                React.createElement("button", { className: styles.quickActionBtn, onClick: () => navigateTo('AssetReturns'), "aria-label": "Asset Returns" },
            ...
            !isAdmin && !isManagerView && (React.createElement(React.Fragment, null,
                React.createElement("button", { className: styles.quickActionBtn, onClick: () => navigateTo('MyWorkspace'), "aria-label": "My Workspace" },
                    React.createElement(Icon, { iconName: "Briefcase" }),
                    React.createElement("span", null, "My Workspace")),
                React.createElement("button", { className: styles.quickActionBtn, onClick: () => navigateTo('Notifications'), "aria-label": "View Notifications" },
        ...
        React.createElement("div", { className: styles.summaryGrid, role: "region", "aria-label": "Key performance indicators" },
            React.createElement("div", { className: `${styles.summaryCard} ${styles.cardBlue}`, role: "status", "aria-label": `${isAdmin ? 'Total Assets' : !isInventoryManager ? 'My Devices' : 'Total Assets'}: ${totalAssets}` },
                ...
                React.createElement("div", { className: styles.cardInfo },
                    ...
                    React.createElement("span", { className: styles.summaryLabel }, isAdmin ? 'Total Assets' : !isInventoryManager ? 'My Devices' : 'Total Assets'),
            ...
            React.createElement("div", { className: `${styles.summaryCard} ${styles.cardGreen}`, role: "status", "aria-label": `Available Assets: ${availableAssets}` },
                React.createElement("div", { className: styles.iconContainer },
                    React.createElement(Icon, { iconName: "Accept" })),
                React.createElement("div", { className: styles.cardInfo },
                    React.createElement("span", { className: styles.summaryValue }, availableAssets),
                    React.createElement("span", { className: styles.summaryLabel }, "Available Assets"),
                    React.createElement("span", { className: styles.summarySubtitle },
                        availableAssets,
                        " in stock (",
                        stockPercentage,
                        "% of total)"))),
            React.createElement("div", { className: `${styles.summaryCard} ${styles.cardPurple}`, role: "status", "aria-label": `${isManagerView ? 'Requests in Queue' : 'Total Requests'}: ${totalRequests}` },
                React.createElement("div", { className: styles.iconContainer },
                    React.createElement(Icon, { iconName: "Send" })),
                React.createElement("div", { className: styles.cardInfo },
                    React.createElement("span", { className: styles.summaryValue }, totalRequests),
                    React.createElement("span", { className: styles.summaryLabel }, isManagerView ? 'Requests in Queue' : 'Total Requests'),
                    React.createElement("span", { className: styles.summarySubtitle }, isAdmin
                        ? `${totalRequests} queue requests`
                        : `Approval success: ${approvalSuccessRate}%`))),
            React.createElement("div", { className: `${styles.summaryCard} ${styles.cardGold}`, role: "status", "aria-label": `${isManagerView ? 'Awaiting Approval' : 'Pending Requests'}: ${isManagerView ? awaitingManagerDecision : pendingRequests}` },
                React.createElement("div", { className: styles.iconContainer },
                ...
                React.createElement("div", { className: styles.cardInfo },
                    ...
                    React.createElement("span", { className: styles.summaryLabel }, isManagerView ? 'Awaiting Approval' : 'Pending Requests'),
            ...
            React.createElement("div", { className: styles.chartCard },
                React.createElement("div", { className: styles.chartHeader },
                    ...
                    React.createElement("div", { className: styles.chartTitleBlock },
                        ...
                        React.createElement("span", { className: styles.chartSubtitle }, "Categorized distribution of equipment"))),
                React.createElement("div", { className: styles.chartContainer },
        ...
        isAdmin && (React.createElement("div", { className: styles.actionCenter },
            React.createElement("div", { className: styles.sectionHeader },
                React.createElement("div", null,
                    ...
                    React.createElement("span", { className: styles.sectionSubtitle }, "Recent manager-approved requests awaiting physical hardware handout by administrators"))),
            React.createElement("div", { className: styles.tableWrapper }, recentAssignments.length > 0 ? (React.createElement("table", { className: styles.actionTable },
                ...
                React.createElement("tbody", null, recentAssignments.map(req => (React.createElement("tr", { key: req.id },
                    ...
                    React.createElement("td", null,
                        React.createElement("span", { className: `${styles.statusBadge} ${styles.badgePending}` }, "Awaiting Handoff")))))))) : (React.createElement("div", { className: styles.noDataMessage },
                ...
                React.createElement("span", { className: styles.emptyStateHint }, "Check the Assignment Queue for historical data")))))),
        isManagerView && (React.createElement("div", { className: styles.actionCenter },
            React.createElement("div", { className: styles.sectionHeader },
                React.createElement("div", null,
                    ...
                    React.createElement("span", { className: styles.sectionSubtitle }, "Recent employee requests awaiting your approval or decline"))),
            React.createElement("div", { className: styles.tableWrapper }, recentApprovals.length > 0 ? (React.createElement("table", { className: styles.actionTable },
                ...
                React.createElement("tbody", null, recentApprovals.map(req => (React.createElement("tr", { key: req.id },
                    ...
                    React.createElement("td", null, req.quantity),
                    React.createElement("td", null, formatDate(req.requestDate)),
                    React.createElement("td", { className: styles.tableCellJustification }, req.reason || 'No justification specified'),
                    React.createElement("td", null,
                        React.createElement("span", { className: `${styles.statusBadge} ${styles.badgePending}` }, "Awaiting Approval")))))))) : (React.createElement("div", { className: styles.noDataMessage },
                ...
                React.createElement("span", { className: styles.emptyStateHint }, "New requests will appear here automatically")))))),
            ...
            React.createElement("div", { className: styles.actionCenter },
                React.createElement("div", { className: styles.sectionHeader },
                    React.createElement("div", null,
                        ...
                        React.createElement("span", { className: styles.sectionSubtitle }, "Recent hardware requests in the verification pipeline"))),
                React.createElement("div", { className: styles.tableWrapper }, recentEmployeeRequests.length > 0 ? (React.createElement("table", { className: styles.actionTable },
                    ...
                    React.createElement("span", { className: styles.emptyStateHint }, "Use \"Request Asset\" to submit a new request"))))),
            React.createElement("div", { className: styles.actionCenter },
                React.createElement("div", { className: styles.sectionHeader },
                    React.createElement("div", null,
                        React.createElement("h3", null,
                        ...
                        React.createElement("span", { className: styles.sectionSubtitle }, "Hardware currently registered and assigned to you"))),
                React.createElement("div", { className: styles.tableWrapper }, items.length > 0 ? (React.createElement("table", { className: styles.actionTable },
                    React.createElement("thead", null,
                        React.createElement("tr", null,
                    ...
                    React.createElement("span", { className: styles.emptyStateHint }, "Assigned devices will appear here after handoff")))))))));
};
