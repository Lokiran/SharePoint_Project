...
export const Dashboard = (props) => {
    ...
    return (React.createElement("div", { className: styles.dashboard },
        ...
        React.createElement("div", { className: styles.summaryGrid },
            React.createElement("div", { className: `${styles.summaryCard} ${styles.cardBlue}` },
            ...
            React.createElement("div", { className: `${styles.summaryCard} ${styles.cardGreen}` },
                React.createElement("div", { className: styles.iconContainer },
                ...
                React.createElement("div", { className: styles.cardInfo },
                    ...
                    React.createElement("span", { className: styles.summarySubtitle },
                        ...
                        stockPercentage,
                        "% of total)"))),
            React.createElement("div", { className: `${styles.summaryCard} ${styles.cardPurple}` },
                React.createElement("div", { className: styles.iconContainer },
            ...
            React.createElement("div", { className: `${styles.summaryCard} ${styles.cardGold}` },
                React.createElement("div", { className: styles.iconContainer },
        ...
        isAdmin && (React.createElement("div", { className: styles.actionCenter },
            React.createElement("div", { className: styles.sectionHeader },
                React.createElement("div", null,
                    React.createElement("h3", null,
                        React.createElement(Icon, { iconName: "ReviewRequestMirrored", style: { marginRight: '8px' } }),
            ...
            React.createElement("div", { className: styles.tableWrapper }, recentAssignments.length > 0 ? (React.createElement("table", { className: styles.actionTable },
                ...
                React.createElement(Icon, { iconName: "CompletedStateMirrored" }),
        ...
        isManagerView && (React.createElement("div", { className: styles.actionCenter },
            React.createElement("div", { className: styles.sectionHeader },
                React.createElement("div", null,
                    React.createElement("h3", null,
                        React.createElement(Icon, { iconName: "ReviewRequest", style: { marginRight: '8px' } }),
        ...
        !isAdmin && !isInventoryManager && (React.createElement("div", { className: styles.splitLayout },
            React.createElement("div", { className: styles.actionCenter },
                React.createElement("div", { className: styles.sectionHeader },
                    React.createElement("div", null,
                        React.createElement("h3", null,
                            React.createElement(Icon, { iconName: "Send", style: { marginRight: '8px' } }),
            ...
            React.createElement("div", { className: styles.actionCenter },
                React.createElement("div", { className: styles.sectionHeader },
                    React.createElement("div", null,
                        React.createElement("h3", null,
                            React.createElement(Icon, { iconName: "AppIconDefault", style: { marginRight: '8px' } }),
