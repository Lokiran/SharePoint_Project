...
export const Dashboard = (props) => {
    ...
    return (React.createElement("div", { className: styles.dashboard },
        ...
        React.createElement("div", { className: styles.summaryGrid, role: "region", "aria-label": "Key performance indicators" },
            ...
            (isAdmin || isInventoryManager) && (React.createElement("div", { className: `${styles.summaryCard} ${styles.cardGreen}`, role: "status", "aria-label": `Available Assets: ${availableAssets}` },
                React.createElement("div", { className: styles.iconContainer },
            ...
            React.createElement("div", { className: `${styles.summaryCard} ${styles.cardPurple}`, role: "status", "aria-label": `${isManagerView ? 'Requests in Queue' : 'Total Requests'}: ${totalRequests}` },
                ...
                React.createElement("div", { className: styles.cardInfo },
                    ...
                    React.createElement("span", { className: styles.summaryLabel }, isManagerView ? 'Requests in Queue' : !isAdmin ? 'My Requests' : 'Total Requests'),
                    React.createElement("span", { className: styles.summarySubtitle }, isAdmin
                        ? `${totalRequests} queue requests`
                        : `Approval success: ${approvalSuccessRate}%`))),
            (isAdmin || isInventoryManager) && (React.createElement("div", { className: `${styles.summaryCard} ${styles.cardGold}`, role: "status", "aria-label": `${isManagerView ? 'Awaiting Approval' : 'Pending Requests'}: ${isManagerView ? awaitingManagerDecision : pendingRequests}` },
                React.createElement("div", { className: styles.iconContainer },
