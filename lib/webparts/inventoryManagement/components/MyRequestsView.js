...
import { Stack, Text, TextField, Dropdown, Icon, DefaultButton, Panel, PanelType, Pivot, PivotItem } from '@fluentui/react';
...
export const MyRequestsView = (props) => {
    ...
    const [returnSelectedStatus, setReturnSelectedStatus] = useState('All');
    // Detail Panel State
    ...
    return (React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: '15px', marginTop: '10px' } },
        React.createElement(Pivot, { "aria-label": strings.MyRequests.PivotAriaLabel },
            React.createElement(PivotItem, { headerText: strings.MyRequests.TabAssetRequests, itemIcon: "Send", itemCount: metrics.total },
                React.createElement("div", { style: { marginTop: '16px', display: 'flex', flexDirection: 'column', gap: '15px' } },
                    ...
                    React.createElement("div", { className: styles.filtersRow },
                        React.createElement("div", { className: styles.searchField },
                            React.createElement(TextField, { placeholder: strings.MyRequests.SearchAssetRequestsPlaceholder, value: searchQuery, onChange: (e, val) => setSearchQuery(val || ''), iconProps: { iconName: 'Search' }, underlined: true })),
                    ...
                    filteredRequests.length > 0 ? (React.createElement("div", { style: {
                        ...
                        return (React.createElement("div", { key: item.id, style: {
                            ...
                            React.createElement("div", { style: { padding: '14px 14px 6px 14px', display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' } },
                                React.createElement("div", null,
                                    ...
                                    React.createElement("span", { style: { fontSize: '0.72rem', color: 'var(--text-muted)' } }, formatString(strings.MyRequests.RequestedPrefix, item.requestDate))),
                            ...
                            React.createElement("div", { style: { padding: '4px 14px 12px 14px', flexGrow: 1, display: 'flex', flexDirection: 'column', gap: '8px' } },
                                ...
                                item.reason && (React.createElement("p", { style: { margin: '0 0 2px 0', fontSize: '0.78rem', color: 'var(--text-muted)', lineHeight: '1.4', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden', height: '32px' } }, formatString(strings.MyRequests.ReasonPrefix, item.reason))),
                            ...
                            React.createElement("div", { style: { padding: '8px 14px 10px 14px', display: 'flex', gap: '6px', borderTop: '1px solid rgba(0, 0, 0, 0.04)', alignItems: 'center' } },
                                React.createElement(DefaultButton, { text: strings.Common.ViewDetails, onClick: () => { setSelectedRequest(item); setIsPanelOpen(true); }, style: { height: '24px', padding: '0 8px', fontSize: '0.72rem', borderRadius: '4px', border: '1px solid #e0e0e0', width: '100%' } }))));
                        ...
                        React.createElement(Text, { variant: "medium", block: true, style: { fontWeight: 600, color: 'var(--text-main)', marginBottom: '4px' } }, strings.MyRequests.EmptyAssetRequestsTitle),
                        React.createElement(Text, { variant: "small", style: { color: 'var(--text-muted)' } }, strings.MyRequests.EmptyFilterHint))))),
            React.createElement(PivotItem, { headerText: strings.MyRequests.TabReturnRequests, itemIcon: "ReturnToSession", itemCount: returnMetrics.total },
                React.createElement("div", { style: { marginTop: '16px', display: 'flex', flexDirection: 'column', gap: '15px' } },
                    React.createElement("div", { className: styles.metricsRow },
                        React.createElement("div", { className: styles.metricItem, style: { minWidth: '90px' } },
                    ...
                    React.createElement("div", { className: styles.filtersRow },
                        React.createElement("div", { className: styles.searchField },
                            React.createElement(TextField, { placeholder: strings.MyRequests.SearchReturnRequestsPlaceholder, value: returnSearchQuery, onChange: (e, val) => setReturnSearchQuery(val || ''), iconProps: { iconName: 'Search' }, underlined: true })),
                        React.createElement("div", { className: styles.filterDropdown, style: { width: '150px' } },
                            React.createElement(Dropdown, { options: [
                                    { key: 'All', text: strings.Dropdowns.AuditLogStatus.All },
                        ...
                        return (React.createElement("div", { key: item.id, style: {
                            ...
                            React.createElement("div", { style: { padding: '14px 14px 6px 14px', display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' } },
                                React.createElement("div", { style: { display: 'flex', gap: '8px', alignItems: 'flex-start' } },
                                    React.createElement(Icon, { iconName: "ReturnToSession", style: { fontSize: '14px', color: 'var(--text-muted)', marginTop: '2px' } }),
                                    React.createElement("div", null,
                                        React.createElement("h4", { style: { margin: 0, fontSize: '0.9rem', fontWeight: 600, color: 'var(--text-main)' } }, item.assetName),
                                        React.createElement("span", { style: { fontSize: '0.72rem', color: 'var(--text-muted)' } }, formatString(strings.MyRequests.SubmittedPrefix, item.serialNumber || strings.Common.NotAvailable, item.requestDate)))),
                                React.createElement("span", { style: { backgroundColor: statusBg, color: statusColor, padding: '2px 8px', borderRadius: '4px', fontSize: '0.68rem', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '4px', whiteSpace: 'nowrap' } },
                                    React.createElement(Icon, { iconName: statusIcon, style: { fontSize: '10px' } }),
                                    displayReturnStatus)),
                            React.createElement("div", { style: { padding: '4px 14px 12px 14px', flexGrow: 1, display: 'flex', flexDirection: 'column', gap: '8px' } },
                                item.returnReason && (React.createElement("p", { style: { margin: '0 0 2px 0', fontSize: '0.78rem', color: 'var(--text-muted)', lineHeight: '1.4', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden', height: '32px' } }, formatString(strings.MyRequests.ReasonPrefix, item.returnReason))),
                                ...
                                item.status === 'Pending' && (React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '4px', fontSize: '0.72rem', color: '#b06000' } },
                                    React.createElement(Icon, { iconName: "Clock", style: { fontSize: '10px' } }),
                                ...
                                item.status === 'Approved' && (React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '4px', fontSize: '0.72rem', color: '#1558d6' } },
                                    React.createElement(Icon, { iconName: "Info", style: { fontSize: '10px' } }),
                                    React.createElement("span", null, strings.MyRequests.HandoverToItTeam)))),
                            React.createElement("div", { style: { padding: '8px 14px 10px 14px', display: 'flex', gap: '6px', borderTop: '1px solid rgba(0, 0, 0, 0.04)', alignItems: 'center' } },
                                React.createElement(DefaultButton, { text: strings.Common.ViewDetails, onClick: () => { setSelectedReturnRequest(item); setIsReturnPanelOpen(true); }, style: { height: '24px', padding: '0 8px', fontSize: '0.72rem', borderRadius: '4px', border: '1px solid #e0e0e0', width: '100%' } }))));
                    }))) : (React.createElement("div", { style: { textAlign: 'center', padding: '30px 10px', backgroundColor: 'var(--surface-bg)', borderRadius: '6px', border: '1px solid rgba(0, 0, 0, 0.08)' } },
                        React.createElement(Icon, { iconName: "ReturnToSession", style: { fontSize: '32px', color: 'var(--text-muted)', marginBottom: '8px' } }),
                        React.createElement(Text, { variant: "medium", block: true, style: { fontWeight: 600, color: 'var(--text-main)', marginBottom: '4px' } }, strings.MyRequests.EmptyReturnRequestsTitle),
                        React.createElement(Text, { variant: "small", style: { color: 'var(--text-muted)' } }, returnRequests.length === 0
                            ? strings.MyRequests.EmptyReturnRequestsHint
                            : strings.MyRequests.EmptyFilterHint)))))),
        selectedRequest && (React.createElement(Panel, { isOpen: isPanelOpen, onDismiss: () => { setIsPanelOpen(false); setSelectedRequest(null); }, type: PanelType.medium, headerText: formatString(strings.MyRequests.DetailsHeaderPrefix, selectedRequest.requestKey || strings.MyRequests.FallbackAssetRequest), closeButtonAriaLabel: strings.Common.Close },
            React.createElement("div", { style: { marginTop: '20px', display: 'flex', flexDirection: 'column', gap: '15px' } },
                React.createElement("div", { className: styles.responsiveGrid, style: { backgroundColor: '#f1f5f9', padding: '15px', borderRadius: '8px', fontSize: '0.88rem' } },
                    React.createElement("div", null,
                ...
                React.createElement(Stack, { horizontal: true, tokens: { childrenGap: 10 }, style: { marginTop: '25px', borderTop: '1px solid #e2e8f0', paddingTop: '15px' } },
                    React.createElement(DefaultButton, { text: strings.Common.Close, onClick: () => { setIsPanelOpen(false); setSelectedRequest(null); } }))))),
        selectedReturnRequest && (React.createElement(Panel, { isOpen: isReturnPanelOpen, onDismiss: () => { setIsReturnPanelOpen(false); setSelectedReturnRequest(null); }, type: PanelType.medium, headerText: formatString(strings.MyRequests.ReturnRequestDetailsPrefix, selectedReturnRequest.assetName), closeButtonAriaLabel: strings.Common.Close },
            React.createElement("div", { style: { marginTop: '20px', display: 'flex', flexDirection: 'column', gap: '15px' } },
                (() => {
                    ...
                    return (React.createElement("div", { style: { backgroundColor: bg, padding: '12px 15px', borderRadius: '8px', display: 'flex', gap: '10px', alignItems: 'flex-start' } },
                        React.createElement(Icon, { iconName: icon, style: { fontSize: '20px', color, marginTop: '2px' } }),
                        React.createElement("div", null,
                            React.createElement("strong", { style: { color, display: 'block', marginBottom: '2px' } }, getReturnRequestStatusDisplayText(selectedReturnRequest.status)),
                ...
                React.createElement("div", { style: { backgroundColor: '#f8fafc', padding: '12px 15px', borderRadius: '8px', border: '1px solid #e2e8f0' } },
                    ...
                    [
                        ...
                        React.createElement("div", { style: {
                            ...
                            } }, step.done && React.createElement(Icon, { iconName: "CheckMark", style: { fontSize: '10px', color: '#ffffff' } })),
                        React.createElement("span", { style: { color: step.done ? '#166534' : '#94a3b8', fontWeight: step.done ? 600 : 400 } }, step.label))))),
                React.createElement(Stack, { horizontal: true, tokens: { childrenGap: 10 }, style: { marginTop: '10px', borderTop: '1px solid #e2e8f0', paddingTop: '15px' } },
                    React.createElement(DefaultButton, { text: strings.Common.Close, onClick: () => { setIsReturnPanelOpen(false); setSelectedReturnRequest(null); } })))))));
};
