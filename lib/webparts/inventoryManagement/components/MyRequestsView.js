...
export const MyRequestsView = (props) => {
    ...
    return (React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: '15px', marginTop: '10px' } },
        React.createElement(Pivot, { "aria-label": "My Requests" },
            React.createElement(PivotItem, { headerText: "Asset Requests", itemIcon: "Send", itemCount: metrics.total },
                        ...
                        return (React.createElement("div", { key: item.id, style: {
                            ...
                            React.createElement("div", { style: { padding: '4px 14px 12px 14px', flexGrow: 1, display: 'flex', flexDirection: 'column', gap: '8px' } },
                                ...
                                item.managerResponse && (React.createElement("div", { style: {
                                    ...
                                    React.createElement("strong", null, "Manager Note:"),
                                    " ",
                            ...
                            React.createElement("div", { style: { padding: '8px 14px 10px 14px', display: 'flex', gap: '6px', borderTop: '1px solid rgba(0, 0, 0, 0.04)', alignItems: 'center' } },
                                React.createElement(DefaultButton, { text: "View Details", onClick: () => { setSelectedRequest(item); setIsPanelOpen(true); }, style: { height: '24px', padding: '0 8px', fontSize: '0.72rem', borderRadius: '4px', border: '1px solid #e0e0e0', width: '100%' } }))));
            ...
            React.createElement(PivotItem, { headerText: "Return Requests", itemIcon: "ReturnToSession", itemCount: returnMetrics.total },
                React.createElement("div", { style: { marginTop: '16px', display: 'flex', flexDirection: 'column', gap: '15px' } },
                    React.createElement("div", { className: styles.metricsRow },
                    ...
                    React.createElement("div", { className: styles.filtersRow },
                        React.createElement("div", { className: styles.searchField },
                            React.createElement(TextField, { placeholder: "Search by asset name, serial number, reason...", value: returnSearchQuery, onChange: (e, val) => setReturnSearchQuery(val || ''), iconProps: { iconName: 'Search' }, underlined: true })),
                    ...
                    filteredReturnRequests.length > 0 ? (React.createElement("div", { style: {
                        ...
                        return (React.createElement("div", { key: item.id, style: {
                            ...
                            React.createElement("div", { style: { padding: '8px 14px 10px 14px', display: 'flex', gap: '6px', borderTop: '1px solid rgba(0, 0, 0, 0.04)', alignItems: 'center' } },
                                React.createElement(DefaultButton, { text: "View Details", onClick: () => { setSelectedReturnRequest(item); setIsReturnPanelOpen(true); }, style: { height: '24px', padding: '0 8px', fontSize: '0.72rem', borderRadius: '4px', border: '1px solid #e0e0e0', width: '100%' } }))));
                    }))) : (React.createElement("div", { style: { textAlign: 'center', padding: '30px 10px', backgroundColor: 'var(--surface-bg)', borderRadius: '6px', border: '1px solid rgba(0, 0, 0, 0.08)' } },
                        React.createElement(Icon, { iconName: "ReturnToSession", style: { fontSize: '32px', color: 'var(--text-muted)', marginBottom: '8px' } }),
                        React.createElement(Text, { variant: "medium", block: true, style: { fontWeight: 600, color: 'var(--text-main)', marginBottom: '4px' } }, "No Return Requests Found"),
        ...
        selectedRequest && (React.createElement(Panel, { isOpen: isPanelOpen, onDismiss: () => { setIsPanelOpen(false); setSelectedRequest(null); }, type: PanelType.medium, headerText: `Request Details: ${selectedRequest.requestKey || 'Asset Request'}`, closeButtonAriaLabel: "Close" },
            React.createElement("div", { style: { marginTop: '20px', display: 'flex', flexDirection: 'column', gap: '15px' } },
                ...
                React.createElement(Stack, { horizontal: true, tokens: { childrenGap: 10 }, style: { marginTop: '25px', borderTop: '1px solid #e2e8f0', paddingTop: '15px' } },
                    React.createElement(DefaultButton, { text: "Close", onClick: () => { setIsPanelOpen(false); setSelectedRequest(null); } }))))),
        selectedReturnRequest && (React.createElement(Panel, { isOpen: isReturnPanelOpen, onDismiss: () => { setIsReturnPanelOpen(false); setSelectedReturnRequest(null); }, type: PanelType.medium, headerText: `Return Request: ${selectedReturnRequest.assetName}`, closeButtonAriaLabel: "Close" },
            React.createElement("div", { style: { marginTop: '20px', display: 'flex', flexDirection: 'column', gap: '15px' } },
                (() => {
                ...
                React.createElement(Stack, { horizontal: true, tokens: { childrenGap: 10 }, style: { marginTop: '10px', borderTop: '1px solid #e2e8f0', paddingTop: '15px' } },
                    React.createElement(DefaultButton, { text: "Close", onClick: () => { setIsReturnPanelOpen(false); setSelectedReturnRequest(null); } })))))));
};
