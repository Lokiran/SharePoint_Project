...
export const InventoryList = (props) => {
        ...
        ...(props.onReturnAsset ? [
            {
                ...
                onRender: (item) => {
                    ...
                    return (React.createElement(PrimaryButton, { text: strings.InventoryList.ActionReturn, onClick: () => props.onReturnAsset(item), styles: { root: { height: 26, padding: '4px 8px', fontSize: '0.8rem' } } }));
                }
            }
        ] : [])
    ...
    return (React.createElement("div", { style: { marginTop: '10px' } },
        React.createElement("div", { className: styles.tableWrapper },
            React.createElement(DetailsList, { items: itemsToRender, columns: columns, groups: groups, setKey: "set", layoutMode: DetailsListLayoutMode.justified, selectionMode: SelectionMode.none })),
        props.enablePagination && totalPages > 1 && (React.createElement("div", { className: styles.paginationContainer },
            React.createElement("div", { className: styles.paginationInfo }, formatString(strings.Pagination.ShowingEntries, startIndex + 1, Math.min(startIndex + pageSize, totalItems), totalItems)),
