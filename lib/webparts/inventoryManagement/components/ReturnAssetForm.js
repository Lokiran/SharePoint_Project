...
export const ReturnAssetForm = (props) => {
    ...
    return (React.createElement(Panel, { isOpen: isOpen, onDismiss: onDismiss, type: PanelType.custom, customWidth: "100%", styles: { main: { maxWidth: '450px' } }, headerText: "Request Asset Return", closeButtonAriaLabel: "Close", onRenderFooterContent: onRenderFooterContent, isFooterAtBottom: true },
