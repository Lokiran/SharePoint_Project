...
export const ReturnAssetForm = (props) => {
    ...
    return (React.createElement(Panel, { isOpen: isOpen, onDismiss: onDismiss, type: PanelType.medium, headerText: "Request Asset Return", closeButtonAriaLabel: "Close", onRenderFooterContent: onRenderFooterContent, isFooterAtBottom: true },
