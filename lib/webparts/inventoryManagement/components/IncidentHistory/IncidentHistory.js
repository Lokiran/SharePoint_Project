...
export const IncidentHistory = (props) => {
    ...
    return (React.createElement("div", { style: { marginTop: '10px' } },
        React.createElement(NexerHeader, { title: "Incident History", subtitle: "Track and manage reported hardware & software incidents" }),
        ...
        React.createElement(Panel, { isOpen: showDetailPanel, onDismiss: () => setShowDetailPanel(false), type: PanelType.medium, headerText: "Incident Details", closeButtonAriaLabel: "Close" }, selectedIncident && (React.createElement("div", { style: { marginTop: '0px' } },
            React.createElement(NexerHeader, { title: `Incident Details - ${selectedIncident.incidentId}`, subtitle: `Reported: ${new Date(selectedIncident.reportedDate).toLocaleString()}`, isPanel: true }),
        ...
        toastNotification && (React.createElement("div", { style: {
            ...
            React.createElement("div", { style: {
                ...
                React.createElement(Icon, { iconName: "Accept", style: { color: '#166534', fontSize: '15px', fontWeight: 'bold' } })),
