    ...
    return (React.createElement("div", { style: { marginTop: '20px' } },
        React.createElement(Stack, { tokens: { childrenGap: 15 } },
            React.createElement("div", { style: { display: 'flex', gap: '15px', alignItems: 'center', flexWrap: 'wrap', marginBottom: '5px' } },
                React.createElement(SearchBox, { placeholder: strings.IncidentHistory.SearchIncidentsPlaceholder, value: searchText, onChange: (ev, newValue) => setSearchText(newValue || ''), onClear: () => setSearchText(''), styles: { root: { width: '100%', maxWidth: 400 } } }),
            ...
            React.createElement(Text, { variant: "small", style: { color: 'var(--text-muted, #6b7280)', display: 'block' } }, formatString(strings.IncidentHistory.ShowingIncidents, filteredIncidents.length, incidents.length)),
            filteredIncidents.length > 0 ? (React.createElement(DetailsList, { items: filteredIncidents, columns: columns, setKey: "incident-list", layoutMode: DetailsListLayoutMode.justified, selectionMode: SelectionMode.none })) : (React.createElement("div", { style: {
                ...
                React.createElement(Text, { variant: "medium", style: { color: '#6b7280' } }, strings.IncidentHistory.NoIncidentsFound)))),
