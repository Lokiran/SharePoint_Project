...
export const RequestList = (props) => {
    ...
    return (React.createElement("div", { style: { marginTop: '10px' } },
        sortedItems.length === 0 ? (React.createElement("p", { style: { fontStyle: 'italic', color: 'var(--text-muted)' } }, "No asset requests found.")) : (React.createElement("div", { className: styles.tableWrapper },
