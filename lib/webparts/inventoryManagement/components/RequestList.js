        ...
        ...(props.canApproveAsset ? [{
                ...
                onRender: (item) => {
                    ...
                    return (React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '8px' } },
                        ...
                        !isApproved && (React.createElement(PrimaryButton, { text: "Approve", onClick: () => props.onApproveAsset && props.onApproveAsset(item), disabled: isBusy }))));
                }
            }] : []),
