...
export const RequestList = (props) => {
    ...
    const columns = [
        ...
        ...(props.canApproveAsset ? [{
                ...
                onRender: (item) => {
                    ...
                    return (React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'nowrap' } },
                        ...
                        !isApproved && (React.createElement(PrimaryButton, { text: strings.RequestList.ButtonReviewAssign, onClick: () => {
        ...
        ...(props.canApproveReject ? [{
                ...
                onRender: (item) => {
                    ...
                    return (React.createElement("div", { style: { display: 'flex', gap: '8px' } },
                        React.createElement(PrimaryButton, { text: strings.Common.Approve, onClick: () => props.onApproveRequest && props.onApproveRequest(item), disabled: isBusy }),
                        React.createElement(PrimaryButton, { text: strings.Common.Reject, onClick: () => {
            ...
            }] : []),
        {
            ...
            maxWidth: 90,
            isResizable: true,
            onRender: (item) => (React.createElement(DefaultButton, { text: strings.Common.View, onClick: () => {
    ...
    return (React.createElement("div", { style: { marginTop: '10px' } },
        sortedItems.length === 0 ? (React.createElement("p", { style: { fontStyle: 'italic', color: 'var(--text-muted)' } }, strings.RequestList.EmptyState)) : (React.createElement("div", { className: styles.tableWrapper },
            React.createElement(DetailsList, { items: sortedItems, columns: columns, setKey: "set", layoutMode: DetailsListLayoutMode.justified, selectionMode: SelectionMode.none }))),
        selectedRequestForDetails && (React.createElement(Panel, { isOpen: isDetailsPanelOpen, onDismiss: () => {
                setIsDetailsPanelOpen(false);
                setSelectedRequestForDetails(null);
            }, type: PanelType.medium, headerText: formatString(strings.RequestList.DetailsHeaderPrefix, selectedRequestForDetails.requestKey || strings.RequestList.DetailsHeaderFallback), closeButtonAriaLabel: strings.Common.Close },
            React.createElement("div", { style: { marginTop: '20px', display: 'flex', flexDirection: 'column', gap: '20px', fontFamily: 'inherit' } },
                ...
                props.canApproveReject && (selectedRequestForDetails.status || '').toLowerCase().includes('pending') && (React.createElement("div", { style: {
                    ...
                    React.createElement(PrimaryButton, { text: props.actionInProgressId === selectedRequestForDetails.id ? strings.Common.Processing : strings.Common.Approve, onClick: () => {
                    ...
                    React.createElement(DefaultButton, { text: strings.Common.Reject, onClick: () => {
                            if (!props.onRejectRequest)
                                return;
                            const rejectionReason = window.prompt(strings.RequestList.RejectionPrompt);
                            if (!rejectionReason || !rejectionReason.trim())
                ...
                props.canApproveAsset && !(selectedRequestForDetails.assetStatus || '').toLowerCase().includes('approv') && (React.createElement("div", { style: {
                    ...
                    React.createElement(PrimaryButton, { text: strings.RequestList.ButtonReviewAssign, onClick: () => {
                            setIsDetailsPanelOpen(false);
                            setSelectedRequestForDetails(null);
                            if (props.onSelectRequestForAssignment) {
