                        ...
                        isAdmin && (React.createElement(PivotItem, { headerText: "Users", itemIcon: "People", itemKey: "Users" },
                            React.createElement("div", { style: { marginTop: '20px' } },
                                ...
                                React.createElement("div", { style: { marginTop: '30px', borderTop: '1px solid rgba(128, 128, 128, 0.15)', paddingTop: '24px' } },
                                    ...
                                    React.createElement(AssetTracking, { items: items, employees: this.state.employees, currentUserRole: effectiveRole, currentUserName: activeUserDisplayName, currentUserEmail: activeUserEmail }))))),
