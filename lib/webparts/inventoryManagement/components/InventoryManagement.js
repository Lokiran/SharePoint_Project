...
import { PrimaryButton, DefaultButton, TextField, Dropdown, DetailsList, DetailsListLayoutMode, SelectionMode, DetailsRow, Panel, PanelType, MessageBar, MessageBarType, ProgressIndicator, Icon, Stack } from '@fluentui/react';
        ...
        return (React.createElement("section", { className: `${styles.inventoryManagement} ${hasTeamsContext ? styles.teams : ''} ${isDarkTheme ? styles.dark : ''}` },
            React.createElement("div", { className: styles.mainContent },
                ...
                React.createElement("div", { className: styles.appLayoutContainer },
                    React.createElement("div", { className: styles.sidebarContainer },
                        ...
                        navItems.map(nav => {
                            ...
                            return (React.createElement("div", { key: nav.key, onClick: () => this.setState({ selectedTabKey: nav.key }), style: {
                                ...
                                React.createElement(Icon, { iconName: nav.icon, style: { fontSize: '15px' } }),
                    ...
                    React.createElement("div", { className: `${styles.card} ${styles.contentContainer}` }, (() => {
                        switch (this.state.selectedTabKey) {
                            case 'Dashboard':
                                return (React.createElement(Dashboard, { items: isAdmin || isManager ? items : myAssets, requests: isAdmin || isManager ? this.state.requests : myRequests, isAdmin: isAdmin, isInventoryManager: isManager }));
                            case 'MyAssets':
                            ...
                            case 'Inventory':
                                return isAdmin ? (React.createElement("div", null,
                                    ...
                                    this.state.loading ? (React.createElement("p", null, "Loading inventory...")) : (React.createElement(InventoryList, { items: items, isAdmin: true, enablePagination: true })))) : null;
                            case 'Approvals':
