    ...
    return (React.createElement("div", { style: { marginTop: '10px' } },
        ...
        React.createElement(Dialog, { hidden: !activeRequest, onDismiss: closeDialog, dialogContentProps: {
            ...
            React.createElement(Stack, { tokens: { childrenGap: 15 }, style: { marginTop: '15px' } },
                ...
                React.createElement(TextField, { label: actionType === 'Reject' ? 'Rejection Reason (Required)' : 'Manager Comments / Verification Notes', placeholder: actionType === 'Reject' ? 'Please specify why this return request is being rejected...' : 'Add check-in details (e.g. checked power cords, verified serial number...)', multiline: true, rows: 3, value: comment, onChange: (_, val) => setComment(val || ''), required: actionType === 'Reject' })),
            React.createElement(DialogFooter, null,
                ...
                React.createElement(DefaultButton, { text: "Cancel", onClick: closeDialog, disabled: submitting })))));
};
