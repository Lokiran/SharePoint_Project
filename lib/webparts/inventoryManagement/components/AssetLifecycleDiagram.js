...
export const AssetLifecycleDiagram = ({ isDarkTheme }) => {
    ...
    return (React.createElement("div", { className: styles.lifecycleDiagram },
        React.createElement("svg", { width: "280", height: "280", viewBox: "0 0 280 280", style: {
            ...
            React.createElement("defs", null,
                React.createElement("linearGradient", { id: "ringGradient", x1: "0%", y1: "0%", x2: "100%", y2: "100%" },
                    React.createElement("stop", { offset: "0%", stopColor: "#ffffff", stopOpacity: 0.1 }),
                    React.createElement("stop", { offset: "50%", stopColor: "#ffffff", stopOpacity: 0.3 }),
                    React.createElement("stop", { offset: "100%", stopColor: "#ffffff", stopOpacity: 0.1 })),
          ...
          `)),
            React.createElement("circle", { className: "animated-ring", cx: "140", cy: "140", r: "90", fill: "none", stroke: "url(#ringGradient)", strokeWidth: "1.5", strokeDasharray: "5, 6" }),
            hoveredNode !== null && (React.createElement("circle", { cx: "140", cy: "140", r: "90", fill: "none", stroke: "rgba(255, 255, 255, 0.35)", strokeWidth: "1.5", strokeDasharray: "8, 8", style: {
        ...
        nodes.map((node) => {
            ...
            return (React.createElement("div", { key: node.id, onMouseEnter: () => setHoveredNode(node.id), onMouseLeave: () => setHoveredNode(null), style: {
                ...
                React.createElement("div", { style: {
                    ...
                    React.createElement(Icon, { iconName: node.icon, style: {
                            fontSize: '15px',
...
//# sourceMappingURL=AssetLifecycleDiagram.js.map