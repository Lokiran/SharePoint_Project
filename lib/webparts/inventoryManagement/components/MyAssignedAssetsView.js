            ...
            return (React.createElement(Panel, { isOpen: isPanelOpen, onDismiss: () => {
                ...
                React.createElement("div", { style: { marginTop: '20px', display: 'flex', flexDirection: 'column', gap: '15px' } },
                    ...
                    React.createElement(Stack, { horizontal: true, tokens: { childrenGap: 10 }, style: { marginTop: '25px', borderTop: '1px solid #e2e8f0', paddingTop: '15px' } },
                        ...
                        !isSelectedPendingReturn && !isSelectedReturnApproved && onAssetReplacement && (React.createElement(DefaultButton, { text: "Asset Replacement", onClick: () => {
                                setIsPanelOpen(false);
                                onAssetReplacement(selectedAsset);
                                setSelectedAsset(null);
                            }, iconProps: { iconName: 'Sync' } })),
                        !isSelectedPendingReturn && !isSelectedReturnApproved && (React.createElement(DefaultButton, { text: "Request Return", onClick: () => {
                                setIsPanelOpen(false);
