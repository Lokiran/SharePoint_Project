export declare const NEXER_COLORS: {
    darkHeader: string;
    headerText: string;
    subtitleText: string;
    accent: string;
...
export declare const generateNexerPdfReport: (options: INexerPdfReportOptions) => Promise<void>;
//# sourceMappingURL=NexerTheme.d.ts.map