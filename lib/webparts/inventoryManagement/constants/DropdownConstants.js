...
// Asset Options
// ==========================================
export const DEFAULT_ASSET_TYPE_OPTIONS = [
...
export const ASSET_CONDITION_VALUES = ASSET_CONDITION_OPTIONS.map(option => option.key);
// ==========================================
// Incident Options
// ==========================================
...
// Request Options
// ==========================================
export const ASSET_REQUEST_PRIORITY_OPTIONS = [
...
// ==========================================
export const AUDIT_LOG_DATE_RANGE_OPTIONS = [
...
// ==========================================
export const INCIDENT_RAISED_TO_OPTIONS = [
