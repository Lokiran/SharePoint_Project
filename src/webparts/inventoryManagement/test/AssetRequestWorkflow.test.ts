...
const mockSP = {
  web: {
    ...
    ensureUser: (name: string) => Promise.resolve({ Id: 12, data: { Id: 12 } })
  }
};
...
describe("Asset Request Workflow Verification", () => {
  ...
  it("should allow manager to approve a request with comments", async () => {
    ...
    await RequestService.updateRequestStatus(1, "Approved", "Manager Approved", "Approved for dev team");
  ...
  it("should allow manager to reject a request", async () => {
    ...
    await RequestService.updateRequestStatus(2, "Declined", "Manager Rejected", "Budget constraints");
