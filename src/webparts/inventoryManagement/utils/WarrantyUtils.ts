 ...
 */
export const formatPrettyDate = (dateStr: string | undefined): string => {
 ...
 */
export const getWarrantyColorInfo = (warrantyExpiryStr: string | undefined): IWarrantyColorInfo => {
 ...
 */
export const getAssetLifecycleInfo = (purchaseDateStr: string | undefined): IAssetLifecycleInfo => {
  if (!purchaseDateStr) {
    return {
