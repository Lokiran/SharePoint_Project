...
const AssetAssignmentService_1 = require("../services/AssetAssignmentService");
...
describe("Asset Assignment Workflow Verification", () => {
    ...
    it("should successfully assign an In Stock asset to an employee", async () => {
        await AssetAssignmentService_1.AssetAssignmentService.assignAssetsToEmployee(["101"], "Adele Vance", "adele@contoso.com", "Admin User", "E1001", "Dev laptop assignment");
