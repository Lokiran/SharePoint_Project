    ...
    render() {
        ...
        return (React.createElement("section", { className: `${InventoryManagement_module_scss_1.default.inventoryManagement} ${hasTeamsContext ? InventoryManagement_module_scss_1.default.teams : ''} ${isDarkTheme ? InventoryManagement_module_scss_1.default.dark : ''}` },
            React.createElement("div", { className: InventoryManagement_module_scss_1.default.mainContent },
                ...
                React.createElement("div", { className: InventoryManagement_module_scss_1.default.card },
                    React.createElement(react_1.Pivot, { "aria-label": "Inventory Management Views", selectedKey: this.state.selectedTabKey, onLinkClick: (item) => item && this.setState({ selectedTabKey: item.props.itemKey }) },
                        React.createElement(react_1.PivotItem, { headerText: "Dashboard", itemIcon: "BarChart4", itemKey: "Dashboard" },
                            React.createElement(Dashboard_1.Dashboard, { items: isAdmin || isManager ? items : myAssets, requests: isAdmin || isManager ? this.state.requests : myRequests, isAdmin: isAdmin, isInventoryManager: isManager })),
                        React.createElement(react_1.PivotItem, { headerText: "My Assets", itemIcon: "Broom", itemKey: "MyAssets" },
                        ...
                        React.createElement(react_1.PivotItem, { headerText: "My Requests", itemIcon: "Send", itemKey: "MyRequests" },
                            React.createElement("div", { style: { marginTop: '20px' } },
                                React.createElement("div", { className: InventoryManagement_module_scss_1.default.cardHeader },
                        ...
                        React.createElement(react_1.PivotItem, { headerText: notifications.filter(n => !n.isRead).length > 0 ? `Notifications (${notifications.filter(n => !n.isRead).length})` : "Notifications", itemIcon: "Ringer", itemKey: "Notifications" },
                            React.createElement(NotificationCenter_1.NotificationCenter, { notifications: notifications, onMarkAsRead: this._markNotificationAsRead, onMarkAllAsRead: this._markAllNotificationsAsRead, onClearNotification: this._clearNotification, onClearAllNotifications: this._clearAllNotifications, onNotificationAction: this._handleNotificationAction })),
                        React.createElement(react_1.PivotItem, { headerText: "Incident History", itemIcon: "History", itemKey: "IncidentHistory" },
                            React.createElement("div", { style: { marginTop: '20px' } },
                        ...
                        isAdmin && (React.createElement(react_1.PivotItem, { headerText: "Inventory", itemIcon: "List", itemKey: "Inventory" },
                            React.createElement("div", { style: { marginTop: '20px' } },
                                React.createElement("div", { className: InventoryManagement_module_scss_1.default.cardHeader },
                                ...
                                this.state.loading ? (React.createElement("p", null, "Loading inventory...")) : (React.createElement(InventoryList_1.InventoryList, { items: items, isAdmin: true, enablePagination: true }))))),
                        isManager && (React.createElement(react_1.PivotItem, { headerText: "Approvals", itemIcon: "DoubleChevronRight12", itemKey: "Approvals" },
                            React.createElement("div", { style: { marginTop: '20px' } },
                                React.createElement("div", { className: InventoryManagement_module_scss_1.default.cardHeader },
                                ...
                                React.createElement(RequestList_1.RequestList, { items: visibleManagerRequests, canApproveReject: true, canApproveAsset: false, hideStatusColumn: false, showResponseColumns: false, onApproveRequest: this._onApproveRequest, onRejectRequest: this._onRejectRequest, actionInProgressId: requestActionInProgressId })))),
                        isAdmin && (React.createElement(react_1.PivotItem, { headerText: "Asset Assignment Queue", itemIcon: "Send", itemKey: "AssetAssignmentQueue" },
                            React.createElement("div", { style: { marginTop: '20px' } },
                                React.createElement("div", { className: InventoryManagement_module_scss_1.default.cardHeader },
                                ...
                                React.createElement(react_1.TextField, { label: "Search by Request ID", placeholder: "e.g. REQ-000123", value: requestSearchId, onChange: (_, value) => this.setState({ requestSearchId: value || '' }), styles: { root: { marginBottom: '12px', maxWidth: 320 } } }),
                                React.createElement(RequestList_1.RequestList, { items: visibleAdminRequests, canApproveReject: false, canApproveAsset: true, hideStatusColumn: true, showResponseColumns: false, onApproveAsset: this._onApproveAsset, actionInProgressId: requestActionInProgressId })))),
                        (isAdmin || isManager) && (React.createElement(react_1.PivotItem, { headerText: "Asset Returns", itemIcon: "ReturnToSession", itemKey: "AssetReturns" },
                            React.createElement("div", { style: { marginTop: '20px' } },
                                React.createElement("div", { className: InventoryManagement_module_scss_1.default.cardHeader },
                                ...
                                React.createElement(ReturnRequestList_1.ReturnRequestList, { items: this.state.returnRequests, isAdmin: isAdmin, isManager: isManager, onUpdateStatus: this._onUpdateReturnRequestStatus, loading: this.state.returnRequestsLoading })))),
                        isAdmin && (React.createElement(react_1.PivotItem, { headerText: "Event Stream", itemIcon: "ActivityFeed", itemKey: "EventStream" },
                            React.createElement(EventStream_1.EventStream, { logs: auditLogs, loading: auditLogsLoading, errorMessage: undefined, currentUserRole: effectiveRole, currentUserName: activeUserDisplayName }))),
                        isAdmin && (React.createElement(react_1.PivotItem, { headerText: "Users", itemIcon: "People", itemKey: "Users" },
                            React.createElement("div", { style: { marginTop: '20px' } },
                                React.createElement("div", { className: InventoryManagement_module_scss_1.default.cardHeader },
                        ...
                        isAdmin && (React.createElement(react_1.PivotItem, { headerText: "Asset Tracking", itemIcon: "EntitlementPolicy", itemKey: "AssetTracking" },
                            React.createElement("div", { style: { marginTop: '20px' } },
                                React.createElement("div", { className: InventoryManagement_module_scss_1.default.cardHeader },
                                ...
                                React.createElement(AssetTracking_1.AssetTracking, { items: items, employees: this.state.employees, currentUserRole: effectiveRole, currentUserName: activeUserDisplayName, currentUserEmail: activeUserEmail, onAssignAssets: this._onAssignAssets, isActionInProgress: !!this.state.isTrackingActionInProgress })))),
                        isAdmin && (React.createElement(react_1.PivotItem, { headerText: "Reports", itemIcon: "ReportDocument", itemKey: "Reports" },
                            React.createElement("div", { style: { marginTop: '20px' } },
                                React.createElement("div", { className: InventoryManagement_module_scss_1.default.cardHeader },
                        ...
                        isAdmin && (React.createElement(react_1.PivotItem, { headerText: "Config", itemIcon: "Settings", itemKey: "Config" },
                            React.createElement("div", { style: { marginTop: '20px' } },
                                React.createElement("div", { className: InventoryManagement_module_scss_1.default.cardHeader },
