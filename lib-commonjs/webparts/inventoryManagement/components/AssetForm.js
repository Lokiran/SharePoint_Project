...
const AssetForm = (props) => {
    ...
    return (React.createElement(react_1.Panel, { isOpen: props.isOpen, onDismiss: props.onClose, type: react_1.PanelType.medium, headerText: isAdmin ? "Add New Asset" : "Register New Asset", closeButtonAriaLabel: "Close" },
        React.createElement(react_1.Stack, { tokens: stackTokens },
            ...
            React.createElement(react_1.Dropdown, { label: "Asset Type", selectedKey: assetType, options: assetTypeOptions, onChange: (_, opt) => setAssetType(opt?.key || 'Other'), required: true }),
            ...
            React.createElement(react_1.Dropdown, { label: "Condition", selectedKey: condition, options: conditionOptions, onChange: (_, opt) => setCondition(opt?.key || 'New') }),
