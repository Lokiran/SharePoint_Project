...
const MyAssignedAssetsView = (props) => {
    ...
    const evaluateWarranty = (expiryStr) => {
        if (!expiryStr)
            return { status: 'Unknown', isExpired: false, isExpiringSoon: false, text: strings.AssetHealth.WarrantyNoneRegistered };
        const expiryDate = new Date(expiryStr);
        if (isNaN(expiryDate.getTime()))
            return { status: 'Unknown', isExpired: false, isExpiringSoon: false, text: strings.AssetHealth.WarrantyInvalidDate };
        const now = new Date();
        ...
        if (diffDays < 0) {
            ...
            return { status: 'Expiring Soon', isExpired: false, isExpiringSoon: true, text: (0, LocalizationUtils_1.formatString)(strings.AssetHealth.WarrantyExpiringSoonDays, diffDays) };
        }
        else {
    ...
    const renderLifecycleAnalysis = (asset) => {
        ...
        return (React.createElement(react_2.Stack, { tokens: { childrenGap: 15 }, style: { marginTop: '20px' } },
            React.createElement("h4", { style: { margin: '0 0 5px 0', borderBottom: '1px solid #e2e8f0', paddingBottom: '8px', color: '#1e293b' } }, strings.AssetHealth.LifecycleReportTitle),
            React.createElement("div", { style: { backgroundColor: '#f8fafc', padding: '12px 15px', borderRadius: '8px', border: '1px solid #e2e8f0' } },
                React.createElement("span", { style: { display: 'block', fontSize: '0.85rem', color: '#64748b', marginBottom: '4px', fontWeight: 600 } }, strings.AssetHealth.LifecycleAgeLabel),
                age !== null ? (React.createElement("span", { style: { fontSize: '0.9rem', color: '#334155' } },
                    (0, LocalizationUtils_1.formatString)(strings.AssetHealth.LifecycleAgeText, age, Math.round(age / 12 * 10) / 10),
                    age >= 36 ? (React.createElement("span", { style: { color: '#b45309', display: 'block', marginTop: '6px', fontWeight: 'bold' } }, strings.AssetHealth.LifecycleRefreshWarning)) : (React.createElement("span", { style: { color: '#166534', display: 'block', marginTop: '6px' } }, (0, LocalizationUtils_1.formatString)(strings.AssetHealth.LifecycleWithinLifecycle, 36 - age))))) : (React.createElement("span", { style: { fontSize: '0.9rem', color: '#64748b' } }, strings.AssetHealth.LifecycleUnknownPurchaseDate))),
            React.createElement("div", { style: { backgroundColor: '#f8fafc', padding: '12px 15px', borderRadius: '8px', border: '1px solid #e2e8f0' } },
                React.createElement("span", { style: { display: 'block', fontSize: '0.85rem', color: '#64748b', marginBottom: '6px', fontWeight: 600 } }, strings.AssetHealth.WarrantyCoverageLabel),
                asset.warrantyExpiry ? (w.isExpired ? (React.createElement(react_2.MessageBar, { messageBarType: react_2.MessageBarType.error, styles: { root: { borderRadius: '6px' } } }, (0, LocalizationUtils_1.formatString)(strings.AssetHealth.WarrantyExpiredMessage, asset.warrantyExpiry))) : w.isExpiringSoon ? (React.createElement(react_2.MessageBar, { messageBarType: react_2.MessageBarType.warning, styles: { root: { borderRadius: '6px' } } }, (0, LocalizationUtils_1.formatString)(strings.AssetHealth.WarrantyExpiringSoonMessage, asset.warrantyExpiry))) : (React.createElement(react_2.MessageBar, { messageBarType: react_2.MessageBarType.success, styles: { root: { borderRadius: '6px' } } }, (0, LocalizationUtils_1.formatString)(strings.AssetHealth.WarrantyActiveMessage, asset.warrantyExpiry)))) : (React.createElement(react_2.MessageBar, { messageBarType: react_2.MessageBarType.info, styles: { root: { borderRadius: '6px' } } }, strings.AssetHealth.WarrantyUnknownMessage))),
            React.createElement("div", { style: { backgroundColor: '#f8fafc', padding: '12px 15px', borderRadius: '8px', border: '1px solid #e2e8f0' } },
                React.createElement("span", { style: { display: 'block', fontSize: '0.85rem', color: '#64748b', marginBottom: '6px', fontWeight: 600 } }, strings.AssetHealth.PhysicalConditionLabel),
                React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '8px', color: '#334155' } },
                    ...
                    React.createElement("span", null,
                        strings.AssetHealth.HealthRatingLabel,
                        " ",
                ...
                isCritical && (React.createElement("div", { style: { marginTop: '10px', padding: '8px', backgroundColor: '#fef2f2', borderRadius: '4px', borderLeft: '3px solid #dc2626' } },
                    React.createElement("span", { style: { fontSize: '0.82rem', color: '#991b1b', fontWeight: 'bold', display: 'block' } }, strings.AssetHealth.RetireRecommendationTitle),
                    React.createElement("span", { style: { fontSize: '0.8rem', color: '#991b1b' } }, (0, LocalizationUtils_1.formatString)(strings.AssetHealth.RetireRecommendationText, condition.toLowerCase()))))),
            asset.specifications && (React.createElement("div", { style: { backgroundColor: '#f8fafc', padding: '12px 15px', borderRadius: '8px', border: '1px solid #e2e8f0' } },
                React.createElement("span", { style: { display: 'block', fontSize: '0.85rem', color: '#64748b', marginBottom: '6px', fontWeight: 600 } }, strings.AssetHealth.SystemSpecificationsLabel),
    ...
    return (React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: '15px' } },
        React.createElement("div", { className: InventoryManagement_module_scss_1.default.metricsRow },
            React.createElement("div", { className: InventoryManagement_module_scss_1.default.metricItem },
                React.createElement("span", { style: { display: 'block', fontSize: '0.7rem', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '2px' } }, strings.AssetHealth.MetricAssignedAssets),
            ...
            React.createElement("div", { className: InventoryManagement_module_scss_1.default.metricItem },
                React.createElement("span", { style: { display: 'block', fontSize: '0.7rem', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '2px' } }, strings.AssetHealth.MetricUnderWarranty),
                React.createElement("span", { style: { fontSize: '1.4rem', fontWeight: 600, color: '#16a34a' } }, metrics.activeWarranties)),
            React.createElement("div", { className: InventoryManagement_module_scss_1.default.metricDivider }),
            React.createElement("div", { className: InventoryManagement_module_scss_1.default.metricItem },
                React.createElement("span", { style: { display: 'block', fontSize: '0.7rem', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '2px' } }, strings.AssetHealth.MetricWarrantyAction),
            ...
            React.createElement("div", { className: InventoryManagement_module_scss_1.default.metricDivider }),
            React.createElement("div", { className: InventoryManagement_module_scss_1.default.metricItem },
                React.createElement("span", { style: { display: 'block', fontSize: '0.7rem', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '2px' } }, strings.AssetHealth.MetricCriticalAlerts),
        ...
        React.createElement("div", { className: InventoryManagement_module_scss_1.default.filtersRow },
            React.createElement("div", { className: InventoryManagement_module_scss_1.default.searchField },
                React.createElement(react_2.TextField, { placeholder: strings.AssetHealth.SearchPlaceholder, value: searchQuery, onChange: (e, val) => setSearchQuery(val || ''), iconProps: { iconName: 'Search' }, underlined: true })),
        ...
        filteredItems.length > 0 ? (React.createElement("div", { style: {
            ...
            return (React.createElement("div", { key: item.id, style: {
                ...
                React.createElement("div", { style: { padding: '4px 14px 12px 14px', flexGrow: 1, display: 'flex', flexDirection: 'column', gap: '8px' } },
                    ...
                    React.createElement("div", { style: {
                        ...
                        React.createElement("span", null,
                            strings.AssetHealth.SerialNumberPrefix,
                            " ",
                            React.createElement("strong", null, item.serialNumber || strings.Common.NotAvailable)),
                        React.createElement("span", null,
                            strings.AssetHealth.PurchasedPrefix,
                            " ",
                            React.createElement("strong", null, item.purchaseDate ? new Date(item.purchaseDate).toLocaleDateString() : strings.Common.NotAvailable))),
                    age !== null && (React.createElement("span", { style: { fontSize: '0.72rem', color: 'var(--text-muted)' } },
                        strings.AssetHealth.AgePrefix,
                        " ",
                        React.createElement("strong", null, age),
                        " ",
                        strings.AssetHealth.AgeSuffix,
                        " ",
                        age >= 36 && React.createElement("span", { style: { color: '#d97706', fontWeight: 500 } }, strings.AssetHealth.RefreshEligible))),
                    item.warrantyExpiry && (w.isExpired || w.isExpiringSoon) && (React.createElement("div", { style: {
                        ...
                        React.createElement("span", null,
                            React.createElement("strong", null, w.isExpired ? strings.AssetHealth.WarrantyExpiredStrip : strings.AssetHealth.WarrantyExpiringStrip),
                            " ",
                            w.text))),
                    item.warrantyExpiry && !w.isExpired && !w.isExpiringSoon && (React.createElement("div", { style: { fontSize: '0.72rem', color: '#137333', display: 'flex', alignItems: 'center', gap: '3px', marginTop: 'auto' } },
                        ...
                        React.createElement("span", null, (0, LocalizationUtils_1.formatString)(strings.AssetHealth.WarrantyActiveStrip, new Date(item.warrantyExpiry).toLocaleDateString()))))),
                React.createElement("div", { style: {
                    ...
                    React.createElement(react_2.DefaultButton, { text: strings.AssetHealth.ButtonDetails, onClick: () => {
                            setSelectedAsset(item);
                            setIsPanelOpen(true);
                        }, style: { height: '24px', padding: '0 6px', fontSize: '0.72rem', borderRadius: '4px', border: '1px solid #e0e0e0', minWidth: 'auto' } }),
                    React.createElement(react_2.DefaultButton, { text: strings.AssetHealth.ButtonReportIssue, onClick: () => onRaiseIncident(item), style: { height: '24px', padding: '0 6px', fontSize: '0.72rem', borderRadius: '4px', border: '1px solid #e0e0e0', minWidth: 'auto' } }),
                    onAssetReplacement && (React.createElement(react_2.DefaultButton, { text: strings.AssetHealth.ButtonAssetReplacement, iconProps: { iconName: 'Sync' }, onClick: () => onAssetReplacement(item), style: { height: '24px', padding: '0 6px', fontSize: '0.72rem', borderRadius: '4px', border: '1px solid #e0e0e0', minWidth: 'auto' } })),
                    isPendingReturn ? (React.createElement("span", { style: {
                            ...
                            borderRadius: '4px',
                            marginLeft: 'auto'
                        } }, strings.AssetHealth.ButtonPendingReturn)) : isReturnApproved ? (React.createElement("span", { style: {
                            ...
                            borderRadius: '4px',
                            marginLeft: 'auto'
                        } }, strings.AssetHealth.ButtonApprovedBadge)) : (React.createElement(react_2.DefaultButton, { text: strings.AssetHealth.ButtonReturn, onClick: () => onReturnAsset(item), style: {
                            height: '24px',
                            padding: '0 6px',
                            fontSize: '0.72rem',
                            borderRadius: '4px',
            ...
            React.createElement(react_2.Text, { variant: "medium", block: true, style: { fontWeight: 600, color: 'var(--text-main)', marginBottom: '4px' } }, strings.AssetHealth.EmptyStateTitle),
            React.createElement(react_2.Text, { variant: "small", style: { color: 'var(--text-muted)' } }, strings.AssetHealth.EmptyStateHint))),
        selectedAsset && (() => {
            ...
            return (React.createElement(react_2.Panel, { isOpen: isPanelOpen, onDismiss: () => {
                ...
                }, type: react_2.PanelType.medium, headerText: (0, LocalizationUtils_1.formatString)(strings.AssetHealth.DetailsHeaderPrefix, selectedAsset.assetName || selectedAsset.title), closeButtonAriaLabel: strings.Common.Close },
                React.createElement("div", { style: { marginTop: '20px', display: 'flex', flexDirection: 'column', gap: '15px' } },
                    React.createElement("div", { className: InventoryManagement_module_scss_1.default.responsiveGrid, style: {
                        ...
                        React.createElement("div", null,
                            React.createElement("span", { style: { color: '#64748b', display: 'block' } }, strings.AssetHealth.LabelAssetType),
                            " ",
                            React.createElement("strong", null, selectedAsset.assetType)),
                        React.createElement("div", null,
                            React.createElement("span", { style: { color: '#64748b', display: 'block' } }, strings.AssetHealth.LabelVendorBrand),
                            " ",
                            React.createElement("strong", null, selectedAsset.vendor || strings.Common.Unknown)),
                        React.createElement("div", null,
                            React.createElement("span", { style: { color: '#64748b', display: 'block' } }, strings.AssetHealth.LabelSerialNumber),
                            " ",
                            React.createElement("strong", null, selectedAsset.serialNumber || strings.Common.NotAvailable)),
                        React.createElement("div", null,
                            React.createElement("span", { style: { color: '#64748b', display: 'block' } }, strings.AssetHealth.LabelAssetStatus),
                            React.createElement("strong", null, isSelectedPendingReturn ? strings.AssetHealth.ButtonPendingReturn : isSelectedReturnApproved ? strings.AssetHealth.ButtonApprovedBadge : selectedAsset.status)),
                        React.createElement("div", { style: { gridColumn: 'span 2' } },
                            React.createElement("span", { style: { color: '#64748b', display: 'block' } }, strings.AssetHealth.LabelTitleDescription),
                            " ",
                    ...
                    React.createElement(react_2.Stack, { horizontal: true, tokens: { childrenGap: 10 }, style: { marginTop: '25px', borderTop: '1px solid #e2e8f0', paddingTop: '15px' } },
                        React.createElement(react_2.PrimaryButton, { text: strings.AssetHealth.ButtonReportIncident, onClick: () => {
                                setIsPanelOpen(false);
                                onRaiseIncident(selectedAsset);
                                setSelectedAsset(null);
                            }, iconProps: { iconName: 'AlertSolid' } }),
                        !isSelectedPendingReturn && !isSelectedReturnApproved && onAssetReplacement && (React.createElement(react_2.DefaultButton, { text: strings.AssetHealth.ButtonAssetReplacement, onClick: () => {
                                setIsPanelOpen(false);
                                onAssetReplacement(selectedAsset);
                                setSelectedAsset(null);
                            }, iconProps: { iconName: 'Sync' } })),
                        !isSelectedPendingReturn && !isSelectedReturnApproved && (React.createElement(react_2.DefaultButton, { text: strings.AssetHealth.ButtonRequestReturn, onClick: () => {
                                setIsPanelOpen(false);
