...
const MyRequestsView = (props) => {
    ...
    return (React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: '15px', marginTop: '10px' } },
        ...
        filteredRequests.length > 0 ? (React.createElement("div", { style: {
            ...
            return (React.createElement("div", { key: item.id, style: {
                ...
                React.createElement("div", { style: {
                    ...
                    React.createElement(react_2.DefaultButton, { text: "View Details", onClick: () => {
        ...
        selectedRequest && (React.createElement(react_2.Panel, { isOpen: isPanelOpen, onDismiss: () => {
                setIsPanelOpen(false);
                setSelectedRequest(null);
            }, type: react_2.PanelType.medium, headerText: `Request Details: ${selectedRequest.requestKey || 'Asset Request'}`, closeButtonAriaLabel: "Close" },
