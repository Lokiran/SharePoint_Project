...
class AuditLogService {
    ...
    static async getAuditLogs() {
        ...
        try {
            let list;
            try {
                list = sp.web.lists.getByTitle(SharePointBaseService_1.SharePointBaseService.LIST_NAME);
        ...
        try {
            let reqList;
            try {
                reqList = sp.web.lists.getByTitle(SharePointBaseService_1.SharePointBaseService.REQUEST_LIST_NAME);
