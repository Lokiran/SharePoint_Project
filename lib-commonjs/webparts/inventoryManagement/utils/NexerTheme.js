...
exports.generateNexerPdfReport = exports.getNexerLogoPng = exports.NEXER_LOGO_BLACK_SVG = exports.NEXER_LOGO_WHITE_SVG = exports.NEXER_COLORS = void 0;
const jspdf_1 = require("jspdf");
exports.NEXER_COLORS = {
    darkHeader: '#111827',
    headerText: '#ffffff',
    subtitleText: '#94a3b8',
    accent: '#0284c7',
...
const getNexerLogoPng = (variant = 'white') => {
    ...
    return new Promise((resolve) => {
        try {
            ...
            const svgString = variant === 'white' ? exports.NEXER_LOGO_WHITE_SVG : exports.NEXER_LOGO_BLACK_SVG;
            const img = new Image();
...
exports.getNexerLogoPng = getNexerLogoPng;
const generateNexerPdfReport = async (options) => {
    try {
        ...
        const logoPng = await (0, exports.getNexerLogoPng)('white');
        if (logoPng) {
...
exports.generateNexerPdfReport = generateNexerPdfReport;
