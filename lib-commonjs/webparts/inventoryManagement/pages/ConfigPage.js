...
const ConfigPage = (props) => {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(react_1.Pivot, { selectedKey: state.configSelectedTab, onLinkClick: (item) => actions.onTabChange(item ? item.props.itemKey || 'operations' : 'operations'), styles: { root: { marginBottom: '20px', borderBottom: '1px solid rgba(128,128,128,0.1)' } } },
        ...
        state.configSelectedTab === 'operations' && (React.createElement("div", { style: { backgroundColor: 'var(--surface-color, #ffffff)', padding: '20px', borderRadius: '8px', border: '1px solid rgba(128, 128, 128, 0.12)', boxShadow: '0 2px 8px rgba(0,0,0,0.04)' } },
            ...
            React.createElement("div", { style: { display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '15px' } },
                React.createElement(react_1.PrimaryButton, { text: state.syncInProgress ? "Processing..." : "Sync Assigned Assets", iconProps: { iconName: 'Sync' }, onClick: actions.onSyncAssignedAssets, disabled: state.syncInProgress }),
                React.createElement(react_1.PrimaryButton, { text: state.syncInProgress ? "Checking Schema..." : "Run Schema Diagnostics", iconProps: { iconName: 'Database' }, onClick: actions.onRunDiagnostics, disabled: state.syncInProgress, styles: {
                        root: { backgroundColor: '#5c2d91', borderColor: '#5c2d91' },
                        rootHovered: { backgroundColor: '#4b2278', borderColor: '#4b2278' }
                    } })),
            state.syncMessage && (React.createElement(react_1.MessageBar, { messageBarType: state.syncMessageType, onDismiss: actions.onDismissSyncMessage, styles: { root: { marginBottom: '15px', borderRadius: '6px' } } }, state.syncMessage)),
            ...
            React.createElement(react_1.Stack, { tokens: { childrenGap: 16 } }, [
                ...
                return (React.createElement("div", { key: list.title, style: { padding: '16px', borderRadius: '8px', border: '1px solid rgba(128, 128, 128, 0.15)', backgroundColor: 'var(--surface-color, #ffffff)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' } },
                    ...
                    React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '12px' } },
                        ...
                        React.createElement(react_1.DefaultButton, { text: "Test Live", iconProps: { iconName: 'PlugConnected' }, onClick: () => actions.onTestListConnection(list.title, list.internal), disabled: connectionStatus === 'testing' }))));
            })))),
            ...
            React.createElement(react_1.Stack, { tokens: { childrenGap: 16 } }, [
                ...
                return (React.createElement("div", { key: item.group, style: { padding: '16px', borderRadius: '8px', border: '1px solid rgba(128, 128, 128, 0.15)', backgroundColor: 'var(--surface-color, #ffffff)' } },
                    React.createElement("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' } },
                        ...
                        React.createElement(react_1.DefaultButton, { text: isLoading ? "Loading..." : "View Members", iconProps: { iconName: 'People' }, onClick: () => actions.onLoadGroupUsers(item.group), disabled: isLoading })),
